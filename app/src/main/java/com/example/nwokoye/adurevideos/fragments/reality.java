...
import com.example.nwokoye.adurevideos.cardreality;
...
public class reality extends Fragment {
    ...
    private cardreality mPlaylistCardAdapter;
    ...
    private void initCardAdapter(final PlaylistVideos playlistVideos) {
        ...
        mPlaylistCardAdapter = new cardreality(playlistVideos, new LastItemReachedListener() {
            @Override
