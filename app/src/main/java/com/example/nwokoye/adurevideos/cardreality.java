 ...
 */
public class cardreality extends RecyclerView.Adapter<cardreality.ViewHolder> {
private final PlaylistVideos mPlaylistVideos;
private final reality.LastItemReachedListener mListener;
...
public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public  cardreality (PlaylistVideos playlistVideos ,reality.LastItemReachedListener lastItemReachedListener) {
    ...
    @Override
    public  cardreality.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
