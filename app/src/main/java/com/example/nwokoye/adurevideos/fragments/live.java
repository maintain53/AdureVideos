...
import com.example.nwokoye.adurevideos.cardlive;
...
public class live extends Fragment {
    ...
    private cardlive mPlaylistCardAdapter;
    ...
    private void initCardAdapter(final PlaylistVideos playlistVideos) {
        ...
        mPlaylistCardAdapter = new cardlive(playlistVideos, new LastItemReachedListener() {
            @Override
