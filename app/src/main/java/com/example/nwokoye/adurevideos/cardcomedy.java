 ...
 */
public class cardcomedy extends RecyclerView.Adapter<cardcomedy.ViewHolder> {
private final PlaylistVideos mPlaylistVideos;
private final comedy.LastItemReachedListener mListener;
...
public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public  cardcomedy (PlaylistVideos playlistVideos ,comedy.LastItemReachedListener lastItemReachedListener) {
    ...
    @Override
    public  cardcomedy.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
