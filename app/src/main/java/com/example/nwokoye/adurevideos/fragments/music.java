...
import com.example.nwokoye.adurevideos.Cardmusic;
...
public class music extends Fragment {
    ...
    private Cardmusic mPlaylistCardAdapter;
    ...
    private void initCardAdapter(final PlaylistVideos playlistVideos) {
        ...
        mPlaylistCardAdapter = new Cardmusic(playlistVideos, new LastItemReachedListener() {
            @Override
