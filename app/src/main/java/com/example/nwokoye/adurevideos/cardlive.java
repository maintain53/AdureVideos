 ...
 */
public class cardlive extends RecyclerView.Adapter<cardlive.ViewHolder> {
    private final PlaylistVideos mPlaylistVideos;
    private final live.LastItemReachedListener mListener;
    ...
    public cardlive(PlaylistVideos playlistVideos, live.LastItemReachedListener lastItemReachedListener) {
    ...
    @Override
    public cardlive.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
