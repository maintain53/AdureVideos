...
/**
 * Created by NWOKOYE on 9/1/2017.
 */
public class Testing extends Fragment {
    ...
    private CardlistAdapter mPlaylistCardAdapter;
    ...
    private void initCardAdapter(final PlaylistVideos playlistVideos) {
        ...
        mPlaylistCardAdapter = new CardlistAdapter(playlistVideos, new LastItemReachedListener() {
            @Override
