...
public class payment extends AppCompatActivity {
    ...
    String backend_url = "https://desolate-ocean-27451.herokuapp.com";
    // Set this to a public key that matches the secret key you supplied while creating the heroku instance
    String paystack_public_key = "pk_test_4166ca25bbbc830d9b0b40d1e6aaff0726d51e31";
            ...
            public void onClick(View view) {
                ...
                if (card != null && card.isValid()) {
                    ...
                    try {
                        ...
                        payment.this.mTextError.setText(String.format("An error occured hwile charging card: %s %s", e.getClass().getSimpleName(), e.getMessage()));
                    }
    ...
    private void chargeCard() {
        ...
        PaystackSdk.chargeCard(payment.this, charge, new Paystack.TransactionCallback() {
            ...
            public void onSuccess(Transaction transaction) {
                ...
                mTextError.setText(" ");
                Toast.makeText(payment.this, transaction.getReference(), Toast.LENGTH_LONG).show();
                updateTextViews();
            ...
            public void onError(Throwable error, Transaction transaction) {
                ...
                if (transaction.getReference() != null) {
                    Toast.makeText(payment.this, transaction.getReference() + " concluded with error: " + error.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private class fetchAccessCodeFromServer extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                payment.this.mTextBackendMessage.setText(String.format("There was a problem getting a new access code form the backend: %s", error));
                dismissDialog();
            }
        }
    ...
    private class verifyOnServer extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            super.onPostExecute(result);
            if (result != null) {
                payment.this.mTextBackendMessage.setText(String.format("Gateway response: %s", result));

            } else {
                payment.this.mTextBackendMessage.setText(String.format("There was a problem verifying %s on the backend: %s ", this.reference, error));
                dismissDialog();
            }
        }
