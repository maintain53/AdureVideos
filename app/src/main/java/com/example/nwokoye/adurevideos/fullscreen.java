...
/**
 * Created by NWOKOYE on 9/2/2017.
 */
public class fullscreen extends YouTubeFailureRecoveryActivity implements
    ...
    private Button fullscreenButton,back;
        ...
        fullscreenButton.setOnClickListener(this);
           back.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View view) {
                   Intent intent = new Intent(fullscreen.this,StartingPoint.class);
