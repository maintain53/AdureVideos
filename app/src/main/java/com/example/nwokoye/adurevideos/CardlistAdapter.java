...
/**
 * Created by NWOKOYE on 8/30/2017.
 */
public class CardlistAdapter extends RecyclerView.Adapter<CardlistAdapter.ViewHolder> {
private final PlaylistVideos mPlaylistVideos;
private final Testing.LastItemReachedListener mListener;
...
public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public  CardlistAdapter (PlaylistVideos playlistVideos, Testing.LastItemReachedListener lastItemReachedListener) {
